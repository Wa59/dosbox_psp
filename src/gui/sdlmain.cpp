...
void GFX_Events() {
	...
	if(state_change && pad.Buttons)
		goto exit;
	if(
		(pad.Buttons == (PSP_CTRL_LTRIGGER | PSP_CTRL_RTRIGGER | PSP_CTRL_START | PSP_CTRL_UP)) ||
		(pad.Buttons == (PSP_CTRL_LTRIGGER | PSP_CTRL_RTRIGGER | PSP_CTRL_START | PSP_CTRL_DOWN)) 
	  ) {
		state_change = true;
		do_joy = true;
		pad.Buttons = 0;
	...
	if(
		...
		(pad.Buttons == (PSP_CTRL_LTRIGGER | PSP_CTRL_RTRIGGER | PSP_CTRL_SELECT | PSP_CTRL_DOWN))
	  ) {
		state_change = true;
		do_keyb = true;
		pad.Buttons = 0;
